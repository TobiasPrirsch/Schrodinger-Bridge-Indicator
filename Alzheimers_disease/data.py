...
class Sne:
    ...
    def __init__(self, batch_size, name):
        ...
        if name == 'non':
            self._sample_tensor = torch.Tensor(np.load('./results/experiments/nonx.npy'))
        elif name == 'gauss':
            self._sample_tensor = torch.Tensor(np.load('./results/experiments/gau3000_unique_right.npy'))
        elif name == 'mild':
            self._sample_tensor = torch.Tensor(np.load('./results/experiments/gau3000_target_right.npy'))
        else:
