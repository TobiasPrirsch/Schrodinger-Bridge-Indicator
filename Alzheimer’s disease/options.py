...
def set():
    ...
    parser.add_argument("--problem-name",   type=str,   default='checkerBoard')
    parser.add_argument("--seed",           type=int,   default=0)
    parser.add_argument("--gpu",            type=int,   default=0,        help="GPU device")
    parser.add_argument("--load",           type=str,   default=None,     help="load the checkpoints")
    parser.add_argument("--dir",            type=str,   default='experiments',     help="directory name to save the experiments under results/")
    ...
    default_config, model_configs = {
        ...
        'morris':         configs.get_checkerboard_default_configs,
    }.get(problem_name)()

    parser.set_defaults(**default_config)       #将选用的problem配置设置
